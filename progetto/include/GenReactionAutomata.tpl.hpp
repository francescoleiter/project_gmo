...
void fgenome_mutation(FRAGen & genome, const std::array<double,3> & probs, double m_prob, double rp_prob, double i_prob){
    return mutation<FAGenome,DTYPE,Reaction,ALPHABET,false>(genome, probs, m_prob, rp_prob,i_prob);
}
void agenome_mutation(ARAGen & genome, const std::array<double,3> & probs, double m_prob,double rp_prob, double i_prob){
    return mutation<AAGenome,DTYPE,Reaction,ALPHABET,true>(genome, probs, m_prob, rp_prob,i_prob);
}

void fgenome_mutation_raw_vctr(DTYPE * ptr, std::size_t len, std::size_t population, std::size_t n_reactions, double mutation_prob, const std::array<double,3>& probs, double m_prob, double rp_prob, double i_prob){
  mutation_raw_vctr<FAGenome,DTYPE,Reaction,ALPHABET,false>(ptr, len, population, n_reactions, mutation_prob, probs, m_prob, rp_prob, i_prob);
}

void agenome_mutation_raw_vctr(DTYPE * ptr, std::size_t len, std::size_t population, std::size_t n_reactions, double mutation_prob, const std::array<double,3>& probs, double m_prob, double rp_prob, double i_prob){
  mutation_raw_vctr<AAGenome,DTYPE,Reaction,ALPHABET,true>(ptr, len, population, n_reactions, mutation_prob, probs, m_prob, rp_prob, i_prob);
}
